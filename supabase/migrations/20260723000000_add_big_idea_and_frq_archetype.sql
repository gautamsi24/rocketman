alter table concepts add column big_idea_code text;
alter table concepts add column big_idea_label text;
...
alter table curriculum_items add column frq_archetype text;
...
alter table curriculum_items add column frq_archetype_source text
